          ...
          try {
            withKubeConfig([credentialsId: 'kubeconfig']) {
			 ...
			 post{
              ...
              perfReport errorFailedThreshold: 0, errorUnstableThreshold: 0, filterRegex: '', persistConstraintLog: true, showTrendGraphs: true, sourceDataFiles: '/var/lib/jenkins/workspace/devsecops-pro/apache-jmeter-5.6.3/bin/Jenkinsjmeter.jtl'
       }
   }
